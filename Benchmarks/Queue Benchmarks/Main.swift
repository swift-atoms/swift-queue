...
/// Family-tier benchmark for swift-queue-primitives (arc-bench W2).
///
...
enum Main {
    static func main() {
        ...
        let groupResults = Bench.queueCases()
    ...
    static func summaryTable(_ results: [Bench.Result]) -> String {
        let subjects = ["tower.direct", "tower.cow", "tower.bounded", "stdlib.shift"]
        var rowKeys: [String] = []
